      ...
      <div className={styles.banner}>
        <div className={styles.banner__hero}>
          ...
          <p>
            ...
            opportunities, enabled by trade. Our goal is to help individuals and
            businesses easily discover quality locally-produced goods while
            providing indigenous producers with access to a wider customer
            network and business support, all at a fair rate for producers and
            consumers. We ensure that producers receive premium value for their
            wares thereby improving their livelihoods and stimulating economic
      ...
      <div className={styles.inner}>
        ...
        <div className={styles.row_1}>
          ...
          <div className={styles.content}>
            <p>
              Cultural Sustenance; Access to Markets; Wealth Creation; Rural
              Transformation;
            </p>
          </div>
        </div>
        <div className={styles.row_2}>
          ...
          <div className={styles.content}>
            <p>
              Locally sourced raw materials and products from 4 geopolitical
              zones in Nigeria. Kano, Plateau, Kaduna, Borno, Ogun,
            </p>
          </div>
        </div>
        <div className={styles.row_3}>
          ...
          <div className={styles.content}>
            <p>
              200 communities reached 100 household supported SDGs 1, 4, 5, 8 &
              17.
            </p>
          </div>
        </div>
            ...
            <div className={styles.box_content}>
              ...
              <p>
                ...
                * Products must have all tags, accessories, original paperwork
                and packaging.
                <br />* Items on sale, bulk and custom order items cannot not be
              ...
              <p>
                ...
                <strong> Ewere@Fairmall.ng</strong>
              </p>
              <p>
                ...
                - Order Number
                <br />
                - Picture sample of item(s) being exchanged
                <br />- Reason
              </p>
            </div>
          </div>
